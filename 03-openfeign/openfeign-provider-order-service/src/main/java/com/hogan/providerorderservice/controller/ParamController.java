...
import com.hogan.providerorderservice.domain.Order;
...
public class ParamController {
    ...
    @GetMapping("oneParamRequiredTrue")
    public String oneParamRequiredTrue(@RequestParam(required = true) String name) {
        System.out.println(name);
        return "ok";
    }
